...
# suitable for the CodeBots (ie: add all the values that don't appear below a 0).
...
# for bots (not just the room directly beneath it). Thus, the answer is 1 + 1 + 1 + 5 + 1 = 9.
